...
<div class="flex min-h-screen bg-[#fafafa] font-sans text-neutral-900 antialiased selection:bg-neutral-900 selection:text-white">
	<!-- Left Sidebar Navigation -->
	<aside class="w-64 border-r-4 border-neutral-900 bg-[#FFDE59] hidden md:flex flex-col justify-between shrink-0">
		<div>
			<div class="h-20 border-b-4 border-neutral-900 px-6 flex items-center bg-white">
				<a href="/" class="text-[18px] font-black tracking-tighter uppercase flex items-center gap-2">
					{data.profile?.name || 'REY SILVA'}
					<span class="text-[10px] bg-neutral-900 text-[#FFDE59] px-2 py-0.5 uppercase tracking-widest shadow-[2px_2px_0px_0px_#171717]">Admin</span>
				</a>
			</div>
