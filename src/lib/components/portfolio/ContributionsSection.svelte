...
{#if contributions && (contributions.length > 0 || commits.length > 0)}
	<section id="contributions" class="mt-40">
		...
		{#if contributions.length > 0}
			<div class="mb-10 flex items-center justify-between gap-4">
				<h3
					class="font-mono text-[11px] font-bold tracking-[0.2em] text-[#222]/50 uppercase"
				>
		...
		{#if commits.length > 0}
			<div class="mb-10 mt-16 flex items-center justify-between gap-4">
				<h3
					class="font-mono text-[11px] font-bold tracking-[0.2em] text-[#222]/50 uppercase"
				>
