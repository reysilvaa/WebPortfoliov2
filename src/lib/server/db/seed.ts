...
async function main() {
	...
	const skillsData = [
		...
		// Frameworks
		{ name: 'Flutter', category: 'Frameworks', order: 8 },
		{ name: 'Riverpod', category: 'Frameworks', order: 9 },
		{ name: 'React.js', category: 'Frameworks', order: 10 },
		{ name: 'Next.js', category: 'Frameworks', order: 11 },
		{ name: 'Svelte 5 / SvelteKit', category: 'Frameworks', order: 12 },
		{ name: 'Tailwind CSS v4', category: 'Frameworks', order: 13 },
		{ name: 'PWA', category: 'Frameworks', order: 14 },
		{ name: 'Laravel', category: 'Frameworks', order: 15 },
		{ name: 'Node.js', category: 'Frameworks', order: 16 },
		{ name: 'NestJS (Fastify)', category: 'Frameworks', order: 17 },
		{ name: 'Express.js', category: 'Frameworks', order: 18 },
		{ name: 'FastAPI', category: 'Frameworks', order: 19 },
		{ name: 'RESTful API design', category: 'Frameworks', order: 20 },
		{ name: 'Drizzle ORM', category: 'Frameworks', order: 21 },
		// Databases & Caching
