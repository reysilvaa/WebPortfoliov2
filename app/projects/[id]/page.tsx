...
import { PrivateRepo } from "./private-repo"

export default function ProjectPage() {
  const { id } = useParams<{ id: string }>()

  // Get project details from imported data
  ...
  // Jika repositori bersifat private, tampilkan komponen PrivateRepo
  if (project.isPrivate) {
    return <PrivateRepo project={project as any} />
  }
      ...
      <div className="terminal-window">
        ...
        <div className="terminal-content">
          ...
          <div className="mb-4">
            ...
            <p>
              <span className="text-primary">category:</span> {project.category.join(", ")}
            </p>
            <p>
              <span className="text-primary">type:</span> {project.type}
            </p>
